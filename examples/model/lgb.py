...
from nclick.model.gbdt import ModelGBDT, plot_feature_importance, lgb_logger, lgb_eval_multi_accuracy
...
if __name__  == '__main__':
    ...
    gbdt_params = {
        ...
        'num_round': 1000,
        'random_seed': 0,
        'feval': lgb_eval_multi_accuracy,
        'callbacks':[lgb_logger(logger_name, verbose=10)],
    }
    ...
    gbdt_config = {
        ...
        'categorical_encoder_type': ['label', 'astype_category', 'target'][1],
